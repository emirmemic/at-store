  ...
  return (
    <header className="container flex items-center justify-between gap-10 py-4">
      <Link href={logoText.href} className="flex items-center gap-3">
        ...
        <span className="font-heading text-sm font-bold md:text-lg lg:text-xl">
          {logoText.label}
        </span>
      </Link>
      ...
      <MobileNavbar>
        <div className="container absolute left-0 right-0 top-0 rounded-b-lg bg-background py-4 text-foreground shadow-xl">
